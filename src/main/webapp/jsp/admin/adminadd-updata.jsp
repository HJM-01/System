        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6 animate-fadeIn">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-6 flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-gray-800">修改账号信息</h2>
                        <p class="text-gray-500 mt-1">填写以下信息修改账户信息</p>
                    </div>
                    <div>
...
<%--                            <input type="hidden" name="id" value="${pet.id}">--%>
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="adminPwd" name="adminPwd" value="${Admin.adminPwd}" required
                                           class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" >
                                </div>
...
<%--                                真实姓名--%>
                                <div class="mb-4">
                                  ...
                                  <input type="text" id="realName" name="realName" value="${Admin.realName}" required
                                         class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="tel" id="telephone" name="telephone" value="${Admin.telephone}" required
                                           class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" >
                                </div>
...
<%--                                生日--%>
                                <div class="mb-4">
                                    ...
                                    <input type="date" id="birthday" name="birthday" value="${Admin.birthday}" required
                                           class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" >
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="sex" name="sex" required
                                        ...
                                        <option value="男" ${Admin.sex == '男' ? 'selected' : ''}>男</option>
                                        <option value="女" ${Admin.sex == '女' ? 'selected' : ''}>女</option>
                                    </select>
                                </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            <button  type="submit" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors shadow-sm hover:shadow" onclick="return confirm('确定要修改吗?')">
